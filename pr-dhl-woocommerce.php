<?php
/**
 * Plugin Name: DHL for WooCommerce Freight (Sweden)
 * Plugin URI: https://github.com/shadimanna/dhl-for-woocommerce-freight
 * Description: WooCommerce integration for Freight (Sweden)
 * Author: DHL
